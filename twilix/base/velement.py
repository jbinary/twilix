...
class VElement(with_metaclass(DeclarativeFieldsMetaClass, MyElement)):
    """
    ...
    def __init__(self, **kwargs):
        ...
        if uri is None and isinstance(self.elementUri, str):
            uri = self.elementUri
        ...
        for attr, node in list(self.nodesProps.items()):
            value = kwargs.get(attr, None)
